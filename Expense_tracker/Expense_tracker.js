...
const inc_amount = document.querySelector('#inc-amt');
...
let transactions = localStorage.getItem("trans") !== null ? JSON.parse(localStorage.getItem("trans")) : [];
...
function addTransaction(e){
    ...
    if(description.value.trim()==""||amount.value.trim==""){
        alert("please Enter proper Description and amount")
    }
    else{
        const transaction={
            id: uniqueId(),
